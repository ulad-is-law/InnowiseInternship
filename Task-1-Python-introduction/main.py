...
def main():
    ...
    try:
        ...
        qrunner.runsql(
            r"C:\Internship\InnowiseInternship\Task-1-Python-introduction\sql_queries\create_tables.sql"
        )
        qrunner.runsql(
            r"C:\Internship\InnowiseInternship\Task-1-Python-introduction\sql_queries\indexes.sql"
        )
